...
/**
 * Request signing for the aoneroom mobile + H5 APIs.
 *
 * Byte-for-byte port of the Python `moviebox_api.v3.crypto` module.
 *   token  -> "<ts>,<md5(reverse(ts))>"
 *   x-tr   -> "<ts>|2|<base64(hmac-md5(canonical, key))>"
 *
 * Lives in :shared so a signing fix applies to BOTH Android + Desktop.
 */
object Crypto {
